...
import hr.algebra.lmandic.procvat.factory.createGetHttpUrlConnection
import java.io.ByteArrayOutputStream
import java.io.File
import java.io.FileOutputStream
import java.net.HttpURLConnection

private const val ARTICLE_PICTURE_WIDTH = 600
private const val ARTICLE_PICTURE_HEIGHT = 400
private const val QUALITY = 100
private const val TAG = "ImgHandler"

fun downloadPicture(context: Context, url: String, fileName: String) : String? {
    // ext
